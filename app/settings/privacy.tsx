      ...
      items: [
        {
          ...
          onPress: () => Linking.openURL('https://humanrightscouncilforindia.org/khabarx/privacy-policy'),
        },
        {
          icon: 'file-text',
          title: 'Terms & Conditions',
          subtitle: 'Your rights and obligations',
          onPress: () => Linking.openURL('https://humanrightscouncilforindia.org/khabarx/terms'),
        },
        {
          icon: 'alert-circle',
          title: 'Disclaimer',
          subtitle: 'Important legal information',
          onPress: () => Linking.openURL('https://humanrightscouncilforindia.org/khabarx/disclaimer'),
        },
        {
          icon: 'book-open',
          title: 'Content Guidelines',
          subtitle: 'What you can and cannot post',
          onPress: () => Linking.openURL('https://humanrightscouncilforindia.org/khabarx/content'),
        },
        {
          icon: 'refresh-ccw',
          title: 'Refund Policy',
          subtitle: 'Refunds and cancellation rules',
          onPress: () => Linking.openURL('https://humanrightscouncilforindia.org/khabarx/refund'),
        },
        {
          icon: 'shield',
          title: 'Data Safety',
          subtitle: 'Play Store data safety information',
          onPress: () => Linking.openURL('https://humanrightscouncilforindia.org/khabarx/data-safety'),
        },
        {
          icon: 'phone',
          title: 'Contact',
          subtitle: 'Get in touch with us',
          onPress: () => Linking.openURL('https://humanrightscouncilforindia.org/khabarx/contact'),
        },
        {
          icon: 'key',
          title: 'Permissions',
