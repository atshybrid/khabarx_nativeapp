...
const styles = StyleSheet.create({
  ...
  photoShell: { width: 88, height: 98, backgroundColor: '#ffffff', alignItems: 'center', justifyContent: 'center', borderWidth: 2, borderColor: '#e5e7eb' },
  photo: { width: 84, height: 94, resizeMode: 'cover' },
  photoPlaceholder: { width: 84, height: 94, alignItems: 'center', justifyContent: 'center' },
  stamp: { position: 'absolute', width: 70, height: 70, borderRadius: 35, bottom: -10, right: -10, backgroundColor: 'transparent' },
