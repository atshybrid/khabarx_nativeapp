...
const styles = StyleSheet.create({
  ...
  photoShell: { width: 120, height: 134, backgroundColor: '#ffffff', alignItems: 'center', justifyContent: 'center', borderWidth: 2, borderColor: '#e5e7eb' },
  photo: { width: 116, height: 130, resizeMode: 'cover' },
  photoPlaceholder: { width: 116, height: 130, alignItems: 'center', justifyContent: 'center' },
  stamp: { position: 'absolute', width: 80, height: 80, borderRadius: 40, bottom: -14, right: -14, backgroundColor: 'transparent' },
  ...
  signatureRow: { flexDirection: 'row', alignItems: 'flex-end', width: '100%', marginTop: 18 },
  ...
  bottomRed: { backgroundColor: RED, paddingVertical: 14, paddingHorizontal: 16, marginTop: 12 },
