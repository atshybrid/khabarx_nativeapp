...
type Props = {
  ...
  active?: boolean;
  activeColor?: string; // fill+stroke color when active
};

// Heart icon with optional filled state
export default function LikeIcon({ size = 24, color = '#9BA1A6', active = false, activeColor = '#fa7c05' }: Props) {
